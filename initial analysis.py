...
# exist for where Starbucks locates their stores and how the locations compare between specific countries/regions.
# To achieve this, I will use a directory of Starbucks stores.
